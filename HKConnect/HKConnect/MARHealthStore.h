...
@interface MARHealthStore : HKHealthStore
...
@property (nonatomic, readonly) NSSet *readTypes;
@property (nonatomic, readonly) NSSet *shareTypes;

@property (nonatomic, readonly) NSDictionary *types;
@property (nonatomic, readonly) NSSet *cumulativeTypes;
@property (nonatomic, readonly) NSSet *quantityTypes;
@property (nonatomic, readonly) NSSet *characteristicTypes;
@property (nonatomic, readonly) NSSet *correlationTypes;
@property (nonatomic, readonly) NSSet *workoutTypes;
