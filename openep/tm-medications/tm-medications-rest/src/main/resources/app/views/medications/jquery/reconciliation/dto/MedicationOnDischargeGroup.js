...
Class.define('app.views.medications.reconciliation.dto.MedicationOnDischargeGroup', 'app.views.medications.reconciliation.dto.MedicationGroup', {
  statics: {
    fromJson: function (jsonObject)
    {
      ...
      var group = new app.views.medications.reconciliation.dto.MedicationOnDischargeGroup({
      ...
      if (!tm.jquery.Utils.isEmpty(jsonObject.groupElements))
      {
        ...
        {
          group.getGroupElements().push(
              app.views.medications.reconciliation.dto.DischargeSourceMedication.fromJson(therapyJsonObject));
        }, this);
      }
