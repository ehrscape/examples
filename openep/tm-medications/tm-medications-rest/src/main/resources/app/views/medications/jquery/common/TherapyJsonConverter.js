...
Class.define('app.views.medications.common.TherapyJsonConverter', 'tm.jquery.Object', {
  statics: {
    ...
    {
      var orderTypeEnum = app.views.medications.TherapyEnums.medicationOrderFormType;
      if (jsonObject.medicationOrderFormType)
      {
        if (jsonObject.medicationOrderFormType === orderTypeEnum.OXYGEN)
        {
