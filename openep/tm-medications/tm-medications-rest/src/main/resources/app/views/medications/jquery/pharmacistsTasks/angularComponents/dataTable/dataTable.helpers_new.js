...
(function (global, factory) {
  ...
  var CellController = (function () {
    ...
    _createClass(CellController, [{
      ...
      value: function styles() {
        ...
        {
          angular.extend(style, this.column.style);
        }
        return style;
      }
    }, {
      ...
      key: "visible", //Marand fix
      value: function visible() {
        return !this.column.hide === true;
      }
    }]);
        ...
        return {
          pre: function pre($scope, $elm, $attrs, ctrl) {
            ...
            if (ctrl.column.template || ctrl.column.cellRenderer) {
              ...
              cellScope.dataItem = ctrl.getValue(); //Marand fix
            }
            ...
            $scope.$watch('cell.row', function () {
              ...
              if (cellScope) {
                ...
                cellScope.dataItem = ctrl.value; //Marand fix
              }
  ...
  var RowController = (function () {
    ...
    _createClass(RowController, [{
      ...
      value: function stylesByGroup(group) {
        //Marand fix
        if(this.options.skipRowStyle === true)
        {
          return;
        }
        var styles = {
  ...
  var SelectionController = (function () {
    ...
    _createClass(SelectionController, [{
      ...
      value: function rowDoubleClicked(event, index, row) {
        //Marand fix
        if(this.options.openPatientDoubleClickHandler)
        {
          this.options.openPatientDoubleClickHandler(row, this.options.therapyViewType);
        }
      }
    }, {
  ...
  var BodyController = (function () {
    ...
    _createClass(BodyController, [{
      ...
      value: function getRows(refresh) {
        ...
        //Marand fix
        if(isNaN(indexes.first))
        {
          indexes.first = 0;
        }
        var rowIndex = indexes.first;
        if((indexes.last === 0) || (isNaN(indexes.last)))
        {
          indexes.last = this.count;
        }
        ...
        //Marand fix
        //if((this.tempRows.length === 0) && (this.rows))
        //{
      ...
      value: function styles() {
          ...
          if (this.options.scrollbarV) {
            styles.height = this.options.internal.bodyHeight + 'px'; //TODO
            //Marand fix
            //styles.height = ($('tm-view').height() - 40 - 50 - 6) + 'px';
          }
        return styles;
      }
    }, {
  ...
  var HeaderController = (function () {
    ...
    _createClass(HeaderController, [{
      ...
      value: function stylesByGroup(group) {
        ...
        {
          styles['height'] =  this.options.headerHeight+'px';
        }
  ...
  //TODO
  setTimeout(function () {
    TableDefaults.internal.bodyHeight = ($('tm-view').height() - 40 - 50 - 6);
  }, 1000);
  ...
  function DataTableDirective($window, $timeout, $parse) {
    return {
      ...
      template: function template(element) {
        ...
        //Marand fix - removed ng-if=\"dt.options.headerHeight\"\n
