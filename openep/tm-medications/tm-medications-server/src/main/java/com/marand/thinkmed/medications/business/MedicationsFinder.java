...
public interface MedicationsFinder
{
  ...
  List<TreeNodeData> findSimilarMedications(long medicationId, @Nonnull List<Long> routeIds, @Nonnull DateTime when);

  List<MedicationDto> findMedicationProducts(long medicationId, @Nonnull List<Long> routeIds, @Nonnull DateTime when);
}
