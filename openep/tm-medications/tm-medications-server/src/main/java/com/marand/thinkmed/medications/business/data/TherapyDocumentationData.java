...
{
  private Pair<MedicationOrderComposition, MedicationInstructionInstruction> instructionPair;
  private final List<Pair<String, Interval>> intervals = new ArrayList<>();
  private TherapyDto therapy;

  public Pair<MedicationOrderComposition, MedicationInstructionInstruction> getInstructionPair()
  {
    return instructionPair;
  }

  public void setInstructionPair(final Pair<MedicationOrderComposition, MedicationInstructionInstruction> instructionPair)
  {
