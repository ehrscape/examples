 ...
 */
public interface PharmacistReviewToEhrConverter
{
  PharmacyReviewReportComposition convert(String patientId, PharmacistReviewDto dto, DateTime when);

  void setPrescriberReferralResponse(
      PharmacyReviewReportComposition composition,
