 ...
 */
public interface TherapyTemplate extends PermanentEntity
{
  String getName();

  void setName(String name);

  TherapyTemplateTypeEnum getType();
  ...
  void setTherapyTemplateElements(Set<TherapyTemplateElement> therapyTemplateElements);
}
