...
// Source: ISPEK - MED - Medication on admission.opt
// Time: 2016-01-22T12:48:05.830+01:00
...
import org.openehr.jaxb.rm.Section;
   ...
   @Template(name="Medication on admission", templateId="ISPEK - MED - Medication on admission")
   @Archetype(name="Medication on admission", archetypeId="openEHR-EHR-COMPOSITION.encounter.v1")
 public class MedicationOnAdmissionComposition extends Composition   implements   IspekComposition  {
               @Deprecated
   @Override
