...
{
  private static final TaskTypeEnum taskTypeEnum = TaskTypeEnum.DISPENSE_MEDICATION;
  ...
  public static final String KEY_PREFIX = "DISPENSE_MEDICATION_TASK_PATIENT_ID";
