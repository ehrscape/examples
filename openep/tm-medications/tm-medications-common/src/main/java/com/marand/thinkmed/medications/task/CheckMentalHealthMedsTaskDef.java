...
{
  private static final TaskTypeEnum taskTypeEnum = TaskTypeEnum.CHECK_MENTAL_HEALTH_MEDS;
  ...
  public static final String KEY_PREFIX = "CHECK_MENTAL_HEALTH_MEDS_TASK_PATIENT_ID";
