...
{
  private static final TaskTypeEnum taskTypeEnum = TaskTypeEnum.PERFUSION_SYRINGE_DISPENSE;
  ...
  public static final String KEY_PREFIX = "PERFUSION_SYRINGE_DISPENSE_TASK_PATIENT_ID";
