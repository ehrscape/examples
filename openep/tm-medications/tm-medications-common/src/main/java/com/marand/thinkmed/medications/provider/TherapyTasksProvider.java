...
package com.marand.thinkmed.medications.provider;
 ...
 */
public interface TherapyTasksProvider
{
  List<TherapyTaskDto> findTherapyTasks(Long patientId, String therapyId, Interval searchInterval);

  void associateTaskWithAdministration(String taskId, String administrationCompositionUid);

  void completeTasks(String ... taskIds);
