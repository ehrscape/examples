...
{
  private static final TaskTypeEnum taskTypeEnum = TaskTypeEnum.PERFUSION_SYRINGE_START;
  ...
  public static final String KEY_PREFIX = "PERFUSION_SYRINGE_START_TASK_PATIENT_ID";
