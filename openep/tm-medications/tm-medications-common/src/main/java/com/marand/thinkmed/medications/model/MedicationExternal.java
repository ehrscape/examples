 ...
 */
public interface MedicationExternal extends EffectiveEntity
{
  ...
  MedicationExternalSystemType getExternalSystemType();

  void setExternalSystemType(final MedicationExternalSystemType externalSystemType);
}
