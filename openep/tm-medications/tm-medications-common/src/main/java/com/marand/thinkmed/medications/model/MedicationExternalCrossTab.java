 ...
 */
public interface MedicationExternalCrossTab extends PermanentEntity
{
  String getExternalSystem();

  void setExternalSystem(String externalSystem);

  MedicationsExternalValueType getValueType();

  void setValueType(MedicationsExternalValueType valueType);
