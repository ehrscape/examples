...
// Source: ISPEK - MED - Medication on discharge.opt
// Time: 2016-01-22T12:48:05.920+01:00
...
import org.openehr.jaxb.rm.Section;
   ...
   @Template(name="Medication on discharge", templateId="ISPEK - MED - Medication on discharge")
   @Archetype(name="Medication on discharge", archetypeId="openEHR-EHR-COMPOSITION.encounter.v1")
 public class MedicationOnDischargeComposition extends Composition   implements   IspekComposition  {
               @Deprecated
   @Override
