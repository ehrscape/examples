// Autogenerated version (not guaranteed to be sequential): 0.5.3.20.gbed7
...
(function (window) {
    ...
    var $ = window.jQuery.noConflict(true), jQuery = $;
    /*
     * $ URIs @VERSION
     * 
   ...
   * });
        ...
        $.rdf.literal.fn = $.rdf.literal.prototype = {
            ...
            init: function (value, options) {
                ...
                } else if ($.typedValue.valid(value, xsdNs + 'double') && !/^\s*([\-\+]?INF|NaN)\s*$/.test(value)) {  // INF, -INF and NaN aren't valid literals in Turtle
    ...
    Channel = (function () {
        ...
        var s_onMessage = function (e) {
            ...
            // IE10 - The context may also be an unloaded window
            if (!this.JSON) return;
    ...
    SMART_CONNECT_CLIENT.prototype.get_family_history_observation = function (p) {
        return this.api_call_wrapper({
            parameters: p || {},
            method: "GET",
    ...
    SMART_CONNECT_CLIENT.prototype.get_family_history_observations = function (p) {
        return this.api_call_wrapper({
            parameters: p || {},
            method: "GET",
