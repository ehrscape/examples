...
// It makes an XDate seem array-like, and displays [ <internal-date>.toString() ]
    ...
    function init(xdate, args) {
        ...
        if (!len) {
            ...
            // Fix by vlad: allow instances of Date or XDate created in another
            // window (or even some other objects having a getTime method)
            else if (isFunction(arg.getTime)) {
